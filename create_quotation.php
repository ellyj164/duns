...
// Check permission to create quotations
if (!userHasPermission($_SESSION['user_id'], 'create-quotation')) {
    $_SESSION['error_message'] = "Access denied. You don't have permission to create quotations.";
